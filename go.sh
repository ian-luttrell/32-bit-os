...
qemu-system-i386 -cpu pentium3 -monitor stdio -fda os.flp -boot order=a -drive id=disk,file=/home/ian/hdd.img,if=none,format=raw -device ide-hd,drive=disk,bus=ide.0,id=ide-controller
